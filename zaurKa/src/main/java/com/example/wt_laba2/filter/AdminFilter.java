...
import com.example.wt_laba2.controller.logic.JSPName;
...
/**
 * AdminFilter is a filter that checks if the user has admin privileges before allowing access to specific resources.
 */
